        ...
        <form onSubmit={handleSubmit}>
          <div className="relative">
            <input
              ...
              autoFocus
              className={`w-full px-4 py-2.5 pr-10 rounded-lg border ${error ? "border-red-400 bg-red-50" : "border-gray-300"} text-sm text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors`}
            />
            <button
              type="button"
          ...
          <p className="text-xs text-gray-400 mt-2">Hint: Melbourne office Wi-Fi password</p>
          <button
            type="submit"
